...
- Panelin en üstünde artık "Opened from `<dosya>:<satır>`" şeklinde, panelin hangi dosya/satırdan açıldığını gösteren tıklanabilir bir bant var; tıklanınca o satıra geri dönülüyor.
